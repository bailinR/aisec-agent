...
询问方向：按业务提示词里的问法发起低门槛确认；问题型优先问是自己用还是家人朋友看，再直接回答最关心的问题；产品介绍型则先确认更关注功能、优势、用处、适用场景还是价格/入口。
...
询问方向：按业务提示词里的问法发起低门槛确认；问题型优先确认当前要解决的具体场景，产品介绍型优先确认更关注功能、优势、用处、适用场景还是价格/入口。
...
询问方向：按业务提示词里的问法发起低门槛确认；问题型优先确认当前是自己要做还是需要代运营/对接，产品介绍型优先确认更关注平台、类目、货源、运营、费用还是合作方式。
...
询问方向：按业务提示词里的示例问法来问，问题型先确认是自己用还是帮家人朋友看，产品介绍型先确认更关注功能、优势、用处、适用场景还是价格/入口。
